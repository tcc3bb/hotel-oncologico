...
-- Copiando dados para a tabela hotel.quarto: ~3 rows (aproximadamente)
DELETE FROM `quarto`;
INSERT INTO `quarto` (`quarto_id`, `tipo_quarto_id`, `quarto_numero`, `quarto_andar`, `quarto_status`, `quarto_observacoes`, `quarto_data_criacao`, `quarto_data_atualizacao`) VALUES
	(1, 2, '1', 'Térreo', 'disponivel', 'Duplo', '2025-10-30 20:34:55', '2025-11-03 01:09:20'),
	(2, 3, '101', 'Térreo', 'disponivel', 'Vista para o jardim', '2025-10-31 01:33:37', '2025-11-03 01:08:52'),
	(3, 4, '102', 'Térreo', 'disponivel', 'Adaptado', '2025-10-31 01:33:37', '2025-11-03 01:08:55');
...
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Registro central das reservas';
...
INSERT INTO `usuario` (`usuario_id`, `usuario_email`, `usuario_senha`, `usuario_tipo`, `usuario_data_criacao`, `usuario_estado`, `usuario_ultimo_login`, `usuario_foto_perfil`) VALUES
	(25, 'paciente@gmail.com', '$2b$10$vzkP7Uaw.XdtM74F4Q6m6ufs8EH3v01JbLXXNL7q4j42uohtgVgJa', 'paciente', '2025-10-23 21:45:01', 'ativo', '2025-11-02 22:07:14', '/uploads/usuarios/padrao.png'),
